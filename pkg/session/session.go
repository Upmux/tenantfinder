...
// NewSession creates a new session object for a url
func NewSession(query string, proxy string, multiRateLimiter *ratelimit.MultiLimiter, timeout int) *Session {
